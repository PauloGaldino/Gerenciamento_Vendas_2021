...
namespace Infrastructure.Configurations.Contexts
{
    public class BaseDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<UserProfile> HserProfiles { get; set; }
        ...
        {
            string strCon = "Data Source=DESKTOP-PAULO\\SQLEXPRESS;Initial Catalog=Gerenciamento_Venda.db;Integrated Security=False;User ID=sa;Password=toor;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
            return strCon;
        }
